...
constexpr std::size_t Nb = 4;//Nmber of Columns
const std::size_t Nr = 10; //Number of Round
const std::size_t Nk = 4; //Number of 32bit words comprising the Cipher Key


const std::array<std::array<std::uint8_t, 4>, 4> MIXBOX = {{
	{0x02, 0x03, 0x01, 0x01},
	{0x01, 0x02, 0x03, 0x01},
	{0x01, 0x01, 0x02, 0x03},
	{0x03, 0x01, 0x01, 0x02}
...
const std::array<std::array<std::uint8_t, 4>, 4> INV_MIXBOX = {{
	{0x0E, 0x0B, 0x0D, 0x09},
	{0x09, 0x0E, 0x0B, 0x0D},
	{0x0D, 0x09, 0x0E, 0x0B},
	{0x0B, 0x0D, 0x09, 0x0E}
...
const std::array<std::array<std::uint8_t, 16>, 16> SBOX = {{
...
const std::array<std::array<std::uint8_t, 16>, 16> INV_SBOX = {{
